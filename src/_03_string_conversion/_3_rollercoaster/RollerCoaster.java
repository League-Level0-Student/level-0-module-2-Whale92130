...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		String height = JOptionPane.showInputDialog(null, "What is your hight in inches");
		...
		int heightAsInt = Integer.parseInt(height);
			if( heightAsInt > 42 ) { 
				...
				JOptionPane.showMessageDialog(null, "You must be at least 42 inches to ride alone");
			}
